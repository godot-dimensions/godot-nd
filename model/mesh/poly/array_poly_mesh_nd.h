...
public:
	...
	void orient_cells_to_boundary_normals(const Vector<VectorN> &p_desired_boundary_normals);
	void orient_cells_to_boundary_normals_bind(const TypedArray<VectorN> &p_desired_boundary_normals);
