...
class EditorImportPluginOFFCellND : public EditorImportPluginOFFBaseND {
	GDCLASS(EditorImportPluginOFFCellND, EditorImportPluginOFFBaseND);
...
public:
	...
	virtual float GDEXTMOD_GET_PRIORITY() const override { return 3.5f; }
#if GDEXTENSION
