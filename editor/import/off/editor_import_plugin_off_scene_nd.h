...
class EditorImportPluginOFFSceneND : public EditorImportPluginOFFBaseND {
	GDCLASS(EditorImportPluginOFFSceneND, EditorImportPluginOFFBaseND);
...
public:
	...
	virtual float GDEXTMOD_GET_PRIORITY() const override { return 1.5f; }
#if GDEXTENSION
